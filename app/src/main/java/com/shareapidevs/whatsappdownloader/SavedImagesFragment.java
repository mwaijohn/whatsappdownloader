...
import adapter.SavedImageAdapter;
...
public class SavedImagesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_saved_images, container, false);
        mRecyclerViewMediaList = (RecyclerView) root.findViewById(R.id.recyclerViewMedia);
        mRecyclerViewMediaList.hasFixedSize();
        ...
        SavedImageAdapter recyclerViewMediaAdapter = new SavedImageAdapter(files, getActivity());
